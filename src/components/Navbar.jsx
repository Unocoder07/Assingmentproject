          ...
          <div className="conatiner">
              <div className="flex justify-between items-center px-8">
                  ...
                  <div className='flex items-center gap-5 '>
                      <div className="flex items-center gap-5 rounded-full border-black border-2 px-3 py-2 group dark:border-white" >
                          <input type="text" placeholder='Search Cars' className="w-21 dark:bg-black hidden group-hover:inline-block transition-all duration-500 focus:outline-none" />
                          <FaSearch className="font-bold text-lg"/>
                      </div>
